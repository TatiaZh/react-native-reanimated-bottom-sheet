...
class BottomSheetBehavior extends React.Component {
  ...
  componentDidMount() {
    this.keyboardDidShowListener = _reactNative.Keyboard.addListener(_reactNative.Platform.select({
    ...
    this.keyboardDidHideListener = _reactNative.Keyboard.addListener(_reactNative.Platform.select({
